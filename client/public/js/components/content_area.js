...
var Network = function (_Component) {
  ...
  _createClass(Network, [{
    ...
    key: 'drawPieChart',
    value: function drawPieChart(_width, _height, _margin, _htmlId, _data) {
      ...
      svg.selectAll('allSlices').data(data_ready).enter().append('path').attr("id", function (d) {
        return d.data.key;
      ...
      svg.selectAll('allPolylines').data(data_ready).enter().append('polyline').attr("stroke", "black").style("fill", "none").attr("stroke-width", 1).attr('points', function (d) {
      ...
      // Add the polylines between chart and labels:
      svg.selectAll('allLabels').data(data_ready).enter().append('text').text(function (d) {
    ...
    value: function getData() {
      ...
      this.getAbi().then(function (data) {
        ...
        d3.csv("data.csv").then(function (data) {
          ...
          _this3.drawPieChart(540, 400, 0, "#plot1", data);
          _this3.drawPieChart(540, 400, 0, "#plot2", data);
